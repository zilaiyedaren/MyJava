...
<body>
    ...
    <s:form action="express_info" method="post" namespace="/info">
        输入express name:<input id="expressName" name="expressName"/>
        输入order号码:<input id="expressOrder" name="expressOrder"/>

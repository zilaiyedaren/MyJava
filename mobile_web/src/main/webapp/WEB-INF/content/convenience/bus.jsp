...
<ul data-role="listview" class="quizzes ui-listview">
    ...
    <li class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-thumb ui-li-static ui-body-c ui-btn-up-c" data-theme="c">
        <div class="ui-btn-inner ui-li ui-li-static ui-body-c">
            <div class="ui-btn-text">
                <a class="ui-link-inherit" href="<s:url action="line" namespace="/convenience/bus" />" rel="external">
                    <img class="ui-li-thumb" src="./images/0.jpg" alt="" width="53" height="53">
                    <div class="quizData">
                        <h4 class="ui-li-heading"><s:if test="#session.locale=='en_US'">query1</s:if><s:else>公交线路查询</s:else></h4>
                    </div>
                </a>
            </div>
    ...
    <li class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-thumb ui-li-static ui-body-c ui-btn-up-c" data-theme="c">
        <div class="ui-btn-inner ui-li ui-li-static ui-body-c">
            <div class="ui-btn-text">
                <a class="ui-link-inherit" href="<s:url action="transfer" namespace="/convenience/bus" />" rel="external">
                    <img class="ui-li-thumb" src="./images/0.jpg" alt="" width="53" height="53">
                    <div class="quizData">
                        <h4 class="ui-li-heading"><s:if test="#session.locale=='en_US'">query2</s:if><s:else>公交换乘查询 </s:else></h4>
                    </div>
                </a>
            </div>
            <span class="arrow-left"></span>
        ...
        <div class="ui-btn-inner ui-li ui-li-static ui-body-c">
            <div class="ui-btn-text">
                <a class="ui-link-inherit" href="<s:url action="station" namespace="/convenience/bus" />" rel="external">
                    <img class="ui-li-thumb" src="./images/0.jpg" alt="" width="53" height="53">
                    <div class="quizData">
                        <h4 class="ui-li-heading"><s:if test="#session.locale=='en_US'">query3</s:if><s:else>公交站点查询 </s:else></h4>
                    </div>
                </a>
            </div>
            <span class="arrow-left"></span>

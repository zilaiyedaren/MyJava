...
import org.wuheng.framework.lucene5.util.Tools;
...
public class SuggesterTest {
    ...
    throws IOException {
        ...
        for(Lookup.LookupResult result:results){
            ...
            Product product=(Product) Tools.deSerialize(is);//反序列化获取product对象
            System.out.println("product-Name:" + product.getName());
            System.out.print("product-regions:");
            for(String s:product.getRegions()){
                System.out.print(s+",");
            }
            System.out.println();
    ...
    public static void main(String[] args){
        try {
            ...
            products.add(new Product("Elextric Guitar","http://images.example/electric-guitar.jpg",
